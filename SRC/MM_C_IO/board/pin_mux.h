...
#define BOARD_INITPINS_BTN3_PORT 0U                   /*!<@brief PORT peripheral base pointer */
...
#define BOARD_INITPINS_LCD_BL_PORT 0U                   /*!<@brief PORT peripheral base pointer */
