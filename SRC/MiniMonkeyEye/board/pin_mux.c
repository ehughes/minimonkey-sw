...
- {pin_num: N2, pin_signal: PIO0_27/FC2_TXD_SCL_MISO_WS/CTIMER3_MAT2/SCT0_OUT6/FC7_RXD_SDA_MOSI_DATA/PLU_OUT0/SECURE_GPIO0_27, label: PIO0_27, identifier: PIO0_31;PIO0_27}
...
- pin_list:
  ...
  - {pin_num: N2, peripheral: GPIO, signal: 'PIO0, 27', pin_signal: PIO0_27/FC2_TXD_SCL_MISO_WS/CTIMER3_MAT2/SCT0_OUT6/FC7_RXD_SDA_MOSI_DATA/PLU_OUT0/SECURE_GPIO0_27,
    identifier: PIO0_27, direction: INPUT, mode: pullUp}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t PIO0_27_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_27 (pin N2)  */
    GPIO_PinInit(BOARD_INITPINS_PIO0_27_GPIO, BOARD_INITPINS_PIO0_27_PORT, BOARD_INITPINS_PIO0_27_PIN, &PIO0_27_config);
    ...
    IOCON->PIO[0][27] = ((IOCON->PIO[0][27] &
                         ...
                         /* Selects pin function.
                          * : PORT027 (pin N2) is configured as PIO0_27. */
