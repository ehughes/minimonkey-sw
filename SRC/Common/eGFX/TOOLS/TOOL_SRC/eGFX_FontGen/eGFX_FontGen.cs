...
namespace eGFX_FontGen
{
    public partial class MainForm : Form
    {
        ...
        private void BuildFontButton_Click(object sender, EventArgs e)
        {
            ...
            MyGFX_Tools.FontBuilder(Generate_FontName(OutputFontFolder), IPT,  SectionPlacementDecoratorTextBox.Text);
        ...
        private void GenerateTT_FontData_Click(object sender, EventArgs e)
        {
           ...
           MyGFX_Tools.FontBuilder(OutputFontFolder, IPT, SectionPlacementDecoratorTextBox.Text);
