...
namespace lib_eGFX_Tools
{
    ...
    public enum eGFX_ImagePlaneType
    {
        ...
        eGFX_IMAGE_PLANE_16BPP_RGB565    = 0x1000,
        eGFX_IMAGE_PLANE_16BPP_BGR565    = 0x1001,
        eGFX_IMAGE_PLANE_16BPP_GBRG3553  = 0x1002,
        eGFX_IMAGE_PLANE_16BPP_GRBG3553  = 0x1003,
    ...
    public class eGFX_Tools
    {
        ...
        public void GenerateSprites(String SpriteDirectory,eGFX_ImagePlaneType IPT,string SectionDecorator)
        {
          ...
          for (int i = 0; i < files.Length; i++)
           {
               ...
               TranslateImage(files[i], ref Code, ref Header, SpritePrefixName+"_", IPT, SectionDecorator);
        ...
        public void FontBuilder(String PathToFontFolder, eGFX_ImagePlaneType IPT, string SectionDecorator)
        {
            if (MessagePost == null)
                 MessagePost += SelfMessagePost;
            ...
            {
                string FileName = MapASCII_CodeToString(i) +  ".png";
                TranslateImage(Path.Combine(PathToFontFolder, "SrcImages", FileName), ref Code, ref Header, MyFontBuilderConfig.CombinedOutputName+"_"+"FontElement_",IPT, SectionDecorator);
                CodeOutput += Code;
            }

            CodeOutput += "\r\n\r\n";
            CodeOutput += SectionDecorator + " " + "const eGFX_Font " + MyFontBuilderConfig.CombinedOutputName + " = { \r\n";
            CodeOutput += "\t\t\t\t\t\t\t{\r\n";
            ...
            HeaderOutput = SectionDecorator + " " + "extern const eGFX_Font " + MyFontBuilderConfig.CombinedOutputName + ";\r\n\r\n";
        ...
        void TranslateImage(string ImageFileName, ref string CodeOutput, ref string HeaderOutput,string SpriteStructNamePrefix, eGFX_ImagePlaneType IPT,string SectionDecorator)
        {
            CodeOutput = "";
            HeaderOutput = "";
            ...
            SectionDecorator = SectionDecorator.Trim();
            SectionDecorator += " ";
            ...
            for (int y = 0; y < Height; y++)
                            ...
                            for (int x = 0; x < Width; x++)
                            {
                                ...
                                switch (NextSprite.Type)
                                {
                                    case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_1BPP:
                                        ...
                                        Y = (UInt32)((PixelColor.R * 0.299) + (PixelColor.G * 0.587) + (PixelColor.B * 0.114));
                                        ...
                                        case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_3BPP_BGR:
                                            ...
                                            NextSprite.PutPixel(x, y, P_3_RGB);
                                    ...
                                    case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_4BPP_XBGR:
                                        ...
                                        NextSprite.PutPixel(x, y, P_4_RGB);
                                    ...
                                    case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_16BPP_RGB565:
                                             P_565 = (uint)(((int)PixelColor.R >> 3 << 11) + ((int)PixelColor.G >> 2 << 5) + ((int)PixelColor.B >> 3));
                                            NextSprite.PutPixel(x, y, P_565);
                                        break;
                                    case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_16BPP_BGR565:
                                             P_565 = (uint)(((int)PixelColor.B >> 3 << 11) + ((int)PixelColor.G >> 2 << 5) + ((int)PixelColor.R >> 3));
                                            NextSprite.PutPixel(x, y, P_565);
                                            break;
                                    ...
                                    case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_16BPP_GBRG3553:
                                            ...
                                            R5_GBRG = (uint)((((int)PixelColor.R) >> 3));
                                            B6_GBRG = (uint)((((int)PixelColor.B) >> 3));
                                            G5_GBRG = (uint)((((int)PixelColor.G) >> 2));
                                            P_3553_GBRG = R5_GBRG << 3;

                                            P_3553_GBRG |= B6_GBRG << 8;

                                            P_3553_GBRG |= (G5_GBRG >> 3);

                                            P_3553_GBRG |= (G5_GBRG & 0x7) << 13; 

                                            NextSprite.PutPixel(x, y, P_3553_GBRG);

                                    break;

                                    case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_16BPP_GRBG3553:

                                        R5_GRBG = (uint)((((int)PixelColor.R) >> 3));
                                        B6_GRBG = (uint)((((int)PixelColor.B) >> 3));
                                        G5_GRBG = (uint)((((int)PixelColor.G) >> 2));
                                        P_3553_GRBG = R5_GRBG << 8;

                                        P_3553_GRBG |= B6_GRBG << 3;

                                        P_3553_GRBG |= (G5_GRBG >> 3);

                                        P_3553_GRBG |= (G5_GRBG & 0x7) << 13;
                            
                                        NextSprite.PutPixel(x, y, P_3553_GRBG);

                                      break;

                                     case eGFX_ImagePlaneType.eGFX_IMAGE_PLANE_24BPP:

                                                        P_24 = (uint)(((int)PixelColor.R) +
                                                                      ((int)PixelColor.G << 8) +
                                                                      ((int)PixelColor.B << 24));
                ...
                HeaderString.Append("\r\n" + SectionDecorator + "extern const eGFX_ImagePlane \t" + SpriteStructNameString + ";\r\n");


                CodeString.Append("\r\n" + SectionDecorator + "const uint8_t " + RawDataArrayString + "[" + NextSprite.Data.Length + "] = { "); 
            ...
            CodeString.Append("\r\n" + SectionDecorator + " " + "const eGFX_ImagePlane " + SpriteStructNameString + " = { " + IPT.ToString() + ",(uint8_t *)&" + RawDataArrayString + ",(uint16_t)" + NextBmp.Width + ",(uint16_t)" + NextBmp.Height + "};\r\n");
